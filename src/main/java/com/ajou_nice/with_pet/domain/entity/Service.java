...
public class Service {
	...
	public void updateServiceInfo(WithPetServiceModifyRequest withPetServiceModifyRequest){
		...
		this.image = withPetServiceModifyRequest.getServiceImg();
		this.introduction = withPetServiceModifyRequest.getServiceIntroduction();
	}

	public static Service toEntity(WithPetServiceRequest withPetServiceRequest){

		String img = withPetServiceRequest.getServiceImg();
		if(withPetServiceRequest.getServiceImg() == null || withPetServiceRequest.getServiceImg().isEmpty()){
