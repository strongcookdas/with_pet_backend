...
public class House {
    ...
    public static House toEntity(PetSitter petSitter, PetSitterHouseRequest petSitterHouseRequest) {
        ...
        String img = petSitterHouseRequest.getHouseImg();
        if (petSitterHouseRequest.getHouseImg() == null || petSitterHouseRequest.getHouseImg()
                .isEmpty()) {
    ...
    public static House of(PetSitter petSitter, HouseRequest houseRequest) {
        return House.builder()
                .petSitter(petSitter)
                .image(houseRequest.getHouseImg())
                .representative(houseRequest.getIsRepresentative())
                .build();
    }
