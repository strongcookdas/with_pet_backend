...
public class CriticalService {
	...
	@Column(name = "criticalservice_id")
	...
	public void updateServiceInfo(CriticalServiceModifyRequest criticalServiceModifyRequest){
		this.name = criticalServiceModifyRequest.getServiceName();
		this.image = criticalServiceModifyRequest.getServiceImg();
	...
	public static CriticalService toEntity(CriticalServiceRequest criticalServiceRequest){
		...
		if(criticalServiceRequest.getServiceImg() == null || criticalServiceRequest.getServiceImg().isEmpty()){
		...
		return CriticalService.builder()
				.name(criticalServiceRequest.getServiceName())
				.image(img)
