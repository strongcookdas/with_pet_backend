...
@Builder
@ToString
public class PetSitterGetMyInfoHouseResponse {
    private Long petSitterHouseId;
    private String petSitterHouseImg;
    private Boolean petSitterHouseRepresentative;

    public static PetSitterGetMyInfoHouseResponse of(House house){
        return PetSitterGetMyInfoHouseResponse.builder()
    ...
    public static List<PetSitterGetMyInfoHouseResponse> toList(List<House> houseList){
        return houseList.stream().map(house -> PetSitterGetMyInfoHouseResponse.builder()
                .petSitterHouseId(house.getId())
                .petSitterHouseImg(house.getHouse_img())
                .petSitterHouseRepresentative(house.getRepresentative())
